...
if [ $# -gt 0 ]; then
	...
	echo "./pymol -c \$_CONDOR_SCRATCH_DIR/SASAquatch.py \$1" >> querySASA.sh
	...
	for line in $(cat $1); do
		...
		# TODO!!! Add the job list name (ex., PtypeATPases versus PDBsforMatt) into the log, error, and output filenames
